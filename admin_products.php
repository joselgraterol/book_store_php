...
<section class="add-products">
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<input type="file" name="image" accept="image/jpg, image/jpeg, image/pnp" class="box" required>
...
<section class="edit-product-form-container">
	<?php 
	...
	<div class="edit-product-form">
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<input type="number" name="update_price" value="<?php echo $fetch_update['price']; ?>" class="box" min="0" required placeholder="enter product price">
			<input type="file" class="box" name="update_image" accept="image/jpg, image/jpeg, image/pnp">
